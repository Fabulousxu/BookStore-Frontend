...
public class ManageController {
  ...
  @PostMapping("/book/{id}")
  public JSONObject setBook(@PathVariable long id, @RequestBody JSONObject param) {
  ...
  @PostMapping("/user/{id}")
  public JSONObject setUser(@PathVariable long id, @RequestBody JSONObject param) {
  ...
  public JSONObject silenceUser(@PathVariable long id) {
    return userService.silenceUser(id);
  }

  @PostMapping("/user/{id}/unsilence")
  public JSONObject unsilenceUser(@PathVariable long id) {
